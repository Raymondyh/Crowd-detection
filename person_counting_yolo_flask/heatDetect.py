...
class HeatDetect:
    ...
    """
    def __init__(self, model_path, video_path, height=500, show=False, show_in=False, show_out=False):
        ...
        if (show_in):
            ...
            self.heatmap = solutions.Heatmap(
                ...
                colormap=cv2.COLORMAP_OCEAN,  # Colormap of heatmap
    ...
    def process_frame(self, frame):
        ...
        处理单帧视频，返回处理后的帧
        """
        return self.heatmap.generate_heatmap(frame)
...
if __name__ == '__main__':
    ...
    model_path = 'model/yolo11x.pt'  # 替换为实际模型路径

    # 创建检测对象
    detector = HeatDetect(model_path, video_path)
